  ...
  return (
    <div
      ...
      style={{
        ...
        filter:
          'progid:DXImageTransform.Microsoft.gradient(startColorstr="#64d1ff",endColorstr="#041331",GradientType=1)',
      }}
    >
      <div
        id={"title"}
      ...
      <img
        ...
        src={banner}
        alt={"Afbeelding van mensen die plastic op een strand opruimen"}
      />
      ...
      >
        ...
        >
          ...
          <p className="text-cyan-950 text-sm font-semibold font-['Montserrat'] text-wrap py-3">
            ...
            <br />
            <br />
            <span className="text-cyan-950 text-xs font-semibold font-['Montserrat'] space-y-0.5 float-left pl-4 -indent-4">
              <li>
      ...
      >
        ...
        <div
          ...
          className="col-start-4 relative z-20 space-y-1 px-3 clear-right"
        >
          <p className="text-cyan-950 font-bold font-['Montserrat'] text-wrap text-center py-3">
