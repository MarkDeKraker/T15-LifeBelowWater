...
import banner from "../assets/0df3b6-iStock-1151212399.jpg";
...
export default function Plastic_2() {
  return (
    <div
      className="sticky grid grid-cols-11 w-full h-full z-0  overflow-y-auto"
      style={{
        background:
          "linear-gradient(180deg, rgba(128,206,250,1) 0%, rgba(93,148,180,1) 55%, rgba(48,99,147,1) 60%, rgba(10,22,34,1) 100%)",
        filter:
          'progid:DXImageTransform.Microsoft.gradient(startColorstr="#80cefa",endColorstr="#0a1622",GradientType=1)',
      }}
    >
      <div
        id={"title"}
      ...
      <img
        ...
        src={banner}
        alt={
          "Grote afbeelding dat plastic vervuiling in de oceaan en een schildpad laat zien"
        }
      />
      ...
      >
        ...
        >
          ...
          <img
            className="h-60 float-left inline-block ml-auto pr-3 py-6 rounded-[40px]"
            src={burning_plastic}
            alt={"information_image"}
          />

          <p className="text-cyan-950 text-sm font-semibold font-['Montserrat'] text-wrap py-5">
            Het is in veel delen van de wereld gebruikelijk dat afval op open
            vuilnisbelten wordt verbrand, wat leidt tot ernstige
            luchtvervuiling. <br />
            <br /> Het verbranden van plastic produceert giftige chemicaliën die
            schadelijk zijn voor, zowel het milieu, als de mensen die de
            vervuilde lucht inademen. Eén van de gevaarlijke stoffen die
            vrijkomen, is zwarte koolstof. Zwarte koolstof kan de aarde veel
            sneller opwarmen, wel tot 5000 keer sneller dan koolstofdioxide.
          </p>
        </div>
      </motion.div>
