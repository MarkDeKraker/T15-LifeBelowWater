...
//           <br />
//           <br />
//           <span className="text-cyan-950 text-sm font-bold font-custom text-wrap pt-3 underline">
...
const whatCanWeDoAboutIt = {
  title: "Wat kunnen wij zelf eraan doen?",
  subTitle: "Plasticvervuiling is een wereldwijd probleem, maar iedereen kan een bijdrage doen om plastic uit de oceaan te houden! Hier zijn wat mogelijkheden die je zelf kunt aannemen en delen met de mensen om je heen:",
  image: "https://i.pinimg.com/originals/75/66/81/756681b81f3d39620094da217b7f1fd4.jpg",
  expandedText:
