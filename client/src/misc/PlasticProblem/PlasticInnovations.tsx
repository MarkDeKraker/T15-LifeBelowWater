...
const plasticInnovations = {
  subTitle: "Plastic heeft de dokters geholpen met spullen die levens redden, het heeft het mogelijk gemaakt om naar de ruimte te gaan, en het heeft auto's en vliegtuigen lichter gemaakt, waardoor ze minder benzine gebruiken en minder vieze lucht maken.",
  image: PlasticInMedical,
  expandedText: (
    <div className="lg:flex justify-around items-center">
      <p className="text-cyan-950 text-sm font-semibold font-custom text-wrap py-3">
        Plastic wordt voor zoveel dingen gebruikt dat het moeilijk is om
