...
const KeyFacts = {
  title: "Plasticvervuiling: Belangrijke Feiten",
  subText:
    <div
      className="col-start-4 relative z-20 space-y-1 pl-3 clear-right"
    >
      <span className="text-cyan-950 text-xs font-semibold font-custom space-y-0.5 float-left text-wrap py-3 pl-4 -indent-4">
        <li>
          De productie is exponentieel toegenomen, van 2,3 miljoen ton in
          1950 tot 400 miljoen ton in 2022.
        </li>
